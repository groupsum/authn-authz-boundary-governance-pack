...
ADR_TEMPLATES = ROOT / "src" / "authnz_policy_governance_pack" / "templates" / "adr"
SPEC_TEMPLATES = ROOT / "src" / "authnz_policy_governance_pack" / "templates" / "specs"
RESERVATION_OWNER = "extension-pack:authnz-policy-governance-pack"
